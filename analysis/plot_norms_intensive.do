...
* this file produces Figure 5 in the manuscript
* author: @lrdegeest
*===============================================================================
...
tw	(line normal_ll norm if sender_type == 0 & target_type == 1, sort lcolor(blue) lw(thick)) ///
	...
	(scatteri 1 29, mcolor(blue) msymbol(O) msize(3)) ///
	(scatteri 1 28, mcolor(orange) msymbol(O) msize(3)), ///
		ytitle("Normalized log-likelihood") xtitle("Contribution norm") ///
		title("Target: High") ///
		xlabel(0(4)30) ///
		legend(off) ///
...
tw	(line normal_ll norm if sender_type == 0, sort lcolor(blue) lw(thick)) ///
	...
	(scatteri 1 8, mcolor(orange) msymbol(O) msize(3)), ///
		ytitle("Normalized log-likelihood") xtitle("Contribution norm") ///
...
tw	(line normal_ll norm if sender_type == 0, sort lcolor(blue) lw(thick)) ///
	(line normal_ll norm if sender_type == 1, sort lcolor(orange) lp(solid) lw(thick)) ///
	(scatteri 1 17, mcolor(blue) msymbol(O) msize(3)) ///
	(scatteri 1 16, mcolor(orange) msymbol(O) msize(3)), ///
		ytitle("Normalized log-likelihood") xtitle("Contribution norm") ///
		title("Target: High") ///
		xlabel(11(2)30) ///
		legend(off) ///
